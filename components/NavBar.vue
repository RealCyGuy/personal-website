<template>
  <nav
    class="flex justify-between px-5 py-8 text-lg sticky w-full top-0 bg-slate-900 overflow-hidden md:px-10 z-20"
  ...
  >
    ...
    >
      <NuxtLink
        to="/"
        class="px-3 hover:text-pink-400 duration-500 mb-10 md:mb-0"
      >
    ...
    >
      <div
        class="w-full h-1 bg-pink-500 group-hover:bg-pink-400 absolute duration-500 top-0 rounded group-aria-expanded:top-1/2 group-aria-expanded:rotate-45 group-aria-expanded:-translate-y-1/2 group-aria-expanded rotate-[540deg]"
      ></div>
      <div
        class="w-full h-1 bg-pink-500 group-hover:bg-pink-400 absolute duration-500 top-1/2 -translate-y-1/2 rounded group-aria-expanded:w-0 rotate-[540deg] group-aria-expanded:rotate-0 left-1/2 -translate-x-1/2 group-aria-expanded:opacity-0"
      ></div>
      <div
        class="w-full h-1 bg-pink-500 group-hover:bg-pink-400 absolute duration-500 top-full -translate-y-full rounded group-aria-expanded:top-1/2 group-aria-expanded:-rotate-45 group-aria-expanded:-translate-y-1/2 rotate-[540deg]"
      ></div>
    </button>
  </nav>
</template>
